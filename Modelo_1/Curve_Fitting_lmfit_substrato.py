...
params.add('mumax_X', value=0.002, min=0.0001, max=0.1)
params.add('K_S', value=3.5, min=0.0001, max=4)
params.add('Y_X_S', value=0.1, min=0, max=1)
params.add('Y_P_S', value=0.7, min=0, max=1)
...
# fit model
result = minimize(residual, params, args=([0, 240], dados_S['concentração'], y0), method='Nelder-Mead')  # leastsq nelder
